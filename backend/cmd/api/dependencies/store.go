...
import (
	"artemmihaylov.gitlab.yandexcloud.net/final-project/momo-store/internal/store/dumplings"
	"artemmihaylov.gitlab.yandexcloud.net/final-project/momo-store/internal/store/dumplings/fake"
)
